...
class VideoProcessor:
    ...
    def _transcribe_and_translate(
        ...
        if src_lang != tgt_lang:
            return self._translate_segments(transcription_result, src_lang, tgt_lang, use_en_as_intermediate)
        else:
    ...
    def _translate_via_english(self, result: Dict, src_lang: str, tgt_lang: str) -> Dict:
                ...
                if original_text:
                    try:
                        ...
                        en_text = (
                            ...
                            if isinstance(en_translation, list) and len(en_translation) > 0
                        ...
                        final_text = (
                            ...
                            if isinstance(final_translation, list) and len(final_translation) > 0
    ...
    def _generate_subtitle_file(self, video_path: str, result: Dict, tgt_lang: str) -> str:
